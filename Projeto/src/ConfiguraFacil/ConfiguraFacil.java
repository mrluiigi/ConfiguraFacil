...
import ConfiguraFacil.configuracoes.Configuracao;
import ConfiguraFacil.configuracoes.ConfiguraçõesDAO;
import ConfiguraFacil.componentes.PacotePrecoComparator;
import ConfiguraFacil.componentes.Pacote;
import ConfiguraFacil.componentes.Componente;
import ConfiguraFacil.componentes.ComponentesDAO;
import ConfiguraFacil.componentes.Opcional;
import ConfiguraFacil.componentes.ComponentePrecoComparator;
import ConfiguraFacil.componentes.Obrigatorio;
...
public class ConfiguraFacil extends Observable{
    ...
    public ConfiguraFacil() throws SQLException, ClassNotFoundException {
    ...
    public boolean ocorremIncompatibilidadesComponentes(Opcional o) throws SQLException{
        ...
        for (int i : this.configuracao.getPacotes()) {
            if(this.componentesDAO.getPacote(i).getListaComponentesIncompativeis().contains(o.getId())) {
                return true;
            }
        }
     /*   for(int i : o.getListaIncompativeis()){
