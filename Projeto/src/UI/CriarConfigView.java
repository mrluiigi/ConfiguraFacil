...
public class CriarConfigView extends javax.swing.JFrame {
    ...
    public CriarConfigView(ConfiguraFacil config){
        ...
        DefaultListModel<ListOb> mot = new DefaultListModel<>();
        DefaultListModel<ListOb> pin = new DefaultListModel<>();
        DefaultListModel<ListOb> est = new DefaultListModel<>();
        DefaultListModel<ListOb> jan = new DefaultListModel<>();
